 ...
 * FosUserUser
 *
 * @ORM\Table(name="fos_user_user", uniqueConstraints={@ORM\UniqueConstraint(name="uniq_c560d76192fc23a8", columns={"username_canonical"}), @ORM\UniqueConstraint(name="uniq_c560d761a0d96fbf", columns={"email_canonical"})}, indexes={@ORM\Index(name="IDX_C560D761E54D836E", columns={"id_dependencia_establecimiento"}), @ORM\Index(name="IDX_C560D761890253C7", columns={"id_empleado"})})
 * @ORM\Entity
 */
class FosUserUser
{
